...
<h1>Artifakt Sample Nuxtjs App</h1>
...
For complete documentation about the Nuxtjs project, please refer to the official [README](./README-original.md) file
...
You can use this stack to run a complete Nuxtjs stack in one docker-compose lines.
